...
FILTER_FILTERFILENAME_ONLYGOODQUALITY="onlygoodquality_$Filter_FILTEREDFILENAME"
log "Filtering only measurements of good quality (G), writing to $FILTER_FILTERFILENAME_ONLYGOODQUALITY$"
grep 'G' $CLEANER_BAREDATAFILENAME$ > $FILTER_FILTERFILENAME_ONLYGOODQUALITY$
# Some examples:
